...
const callCloud = async () => {
    ...
    // const address = '0x493B3431e8CbB9C3752c77f7cA0E50eabF5BCe30'
    // const abi = [
    //     {
    //         anonymous: false,
    //         inputs: [
    ...
    //     },
    // ]
    // const web3 = Moralis.web3ByChain('0x61') // BSC
    // const contract = new web3.eth.Contract(abi, address)
    // const res = await contract.methods.distribute(request.params.contractAddress,request.params.list).call()
